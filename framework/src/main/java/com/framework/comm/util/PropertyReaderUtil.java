...
public class PropertyReaderUtil {
	 ...
	 * @return
	 */
	private static Properties loadPropertyFile(Class<?> classes, String propertyFilePath) {
		InputStream is = getClassLoader(classes).getResourceAsStream(propertyFilePath);
		if (is == null)
	...
	public static ClassLoader getClassLoader(Class<?> cls) {
		...
		if (cl == null) {
			cl = PropertyReaderUtil.class.getClassLoader();
		}
		if (cl == null) {
