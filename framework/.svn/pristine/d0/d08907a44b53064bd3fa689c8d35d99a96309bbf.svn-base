...
public class IPSeeker {
	...
	public static void main(String[] args) {
		...
		String qqwryPath = "E:/qqwry.dat";// IP地址库地址
		IPSeeker seeker = IPSeeker.getInstance(qqwryPath);
		String area = seeker.getAddress("183.62.39.234");
		System.out.println(area);

		byte[] ip = IPUtils.getIpByteArrayFromString("183.62.39.234");
		IPLocation info = null;
		info = seeker.getIPLocation(ip);
		System.out.println(info.area + "," + info.country);

	}

	private static final String IP_FILE = "E:/qqwry.dat";
	 ...
	 *            QQIP地址库地址
	 */
	private IPSeeker(String qqwryPath) {
		...
		try {
			...
			ipFile = new RandomAccessFile(qqwryPath, "r");
		} catch (FileNotFoundException e) {
			System.out.println(IPSeeker.class.getResource("").toString().substring(6) + "/qqwry.dat");
	 ...
	 * @return 单一实例
	 */
	public static synchronized IPSeeker getInstance(String qqwryPath) {
		if (instance == null) {
			instance = new IPSeeker(qqwryPath);
		}
		return instance;
	}
